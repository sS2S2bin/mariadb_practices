...
-- 문제6. 9명
-- 현재 부서 매니저는 몇 명이나 있나요?(역임 매너저는 제외) to_date '9999-01-01' 현재데이터
select count(emp_no)
from dept_manager
where to_date='9999-01-01';
...
-- 문제8. 8297명 > 현재 조건 넣고 2159
-- 현재 급여가 120,000이상 받는 사원은 몇 명이나 있습니까?
select count(emp_no) from salaries where salary>='120000' and to_date like '9999%';
